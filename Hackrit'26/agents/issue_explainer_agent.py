"""Issue Explainer Agent for RepoRamp.

Uses cheap/efficient model (default: Gemma 4 / gemma-4-31b-it) to explain
...
ISSUE_EXPLAINER_INSTRUCTION = """You are the RepoRamp Issue Explainer Agent.

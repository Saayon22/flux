"""Complexity Router for RepoRamp ADK Workflow Runtime.
...
def evaluate_diff_complexity(
    ...
    if tool_context:
        ...
        # Inform ADK workflow runtime of selected route
...
def generate_plan_artifact(
    ...
    Args:
        diff_stats: Optional dictionary of diff statistics.
        tool_context: The ADK ToolContext for session state.
    ...
    if issue_context:
        plan["issue_context"] = issue_context[:200]
...
# FunctionNode for Workflow Runtime graph
